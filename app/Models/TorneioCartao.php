...
class TorneioCartao extends Model
{
    protected $table = 'torneio_cartoes';

    protected $fillable = ['torneio_jogo_id', 'torneio_time_id', 'torneio_participante_id', 'tipo', 'quantidade'];
