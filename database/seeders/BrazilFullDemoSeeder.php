    ...
    private function seedPlayerProfiles(array $users): void
    {
        ...
        foreach ($allUsers->values() as $index => $user) {
            ...
            $profile->update([
                ...
                'bio' => 'Peladeiro de teste com perfil completo para validar ranking, avaliações, convites e denuncias.',
            ...
            for ($i = 0; $i < 2; $i++) {
                ...
                $pelada = Pelada::updateOrCreate(
                    ...
                    [
                        ...
                        'descricao' => 'Pelada completa para testar busca, inscricoes, caixa, rodadas, sorteio e avaliações em '.$state['cidade'].'.',
