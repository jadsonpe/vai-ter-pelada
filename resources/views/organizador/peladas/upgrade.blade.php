<x-app-layout>
    <div class="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <section class="rounded-lg border border-slate-200 bg-white p-8 shadow-sm">
            <p class="text-sm font-semibold uppercase tracking-wide text-emerald-700">Atualização de plano</p>
            <h1 class="mt-2 text-3xl font-bold text-slate-900">Você atingiu o limite do plano grátis</h1>
            <p class="mt-3 text-slate-600">
                Seu plano atual permite criar {{ $limite }} {{ $limite === 1 ? 'pelada' : 'peladas' }}. Você já criou {{ $peladasCriadas }}.
                Para organizar mais peladas, será necessário atualizar seu plano.
            </p>

            <div class="mt-8 grid gap-5 md:grid-cols-2">
                <div class="rounded-lg border border-slate-200 p-5">
                    <h2 class="text-lg font-semibold text-slate-900">Grátis</h2>
                ...
                <div class="rounded-lg border-2 border-emerald-500 p-5">
                    ...
                    <p class="mt-2 text-sm text-slate-600">Para quem organiza várias peladas, turmas ou horários.</p>
