        ...
        <section class="overflow-hidden rounded-lg bg-slate-950 text-white shadow-sm">
            <div class="grid gap-6 px-6 py-8 lg:grid-cols-[1fr_320px] lg:px-8">
                <div>
                    ...
                    <p class="mt-3 max-w-2xl text-slate-300">Encontre peladas para jogar ou crie a sua propria. Quando voce cria uma pelada, passa a ser o organizador dela.</p>
        ...
        <div class="mt-6 grid gap-6 lg:grid-cols-[1fr_360px]">
            <section class="rounded-lg border border-slate-200 bg-white shadow-sm">
                <div class="border-b border-slate-100 px-5 py-4">
                    <h2 class="text-lg font-semibold text-slate-900">Proximas rodadas</h2>
            ...
            <aside class="space-y-6">
                ...
                <section class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div class="mt-4 space-y-3">
                        ...
                        @empty
                            <p class="text-sm text-slate-500">Voce ainda nao participa de nenhuma pelada.</p>
                        @endforelse
                    </div>
                </section>

                <section class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                    <h2 class="text-lg font-semibold text-slate-900">Historico recente</h2>
                    <div class="mt-4 divide-y divide-slate-100">
                        ...
                        @empty
                            <p class="text-sm text-slate-500">Nenhuma participacao registrada ainda.</p>
                        @endforelse
                    </div>
                </section>
            </aside>
